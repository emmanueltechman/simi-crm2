...
@section('content')
 ...
 <div class="row mb-1">
                                                <div class="col-sm-12">
                                                    <label for="toAddInfo"
                                                           class="caption">{{trans('quotes.proposal')}}</label>
                                    ...
                                    <table class="table-responsive tfr my_stripe">
                                        ...
                                        <tr class="sub_c" style="display: table-row;">
                                            ...
                                            <td align="left" colspan="2"><input type="text" class="form-control shipVal"
                                                                                ...
                                                                                onkeyup="billUpyog()">
                                                (&nbsp;<label for="ship_tax_toggle" class="form-check-label"><input type="checkbox" value="1" class="form-check-inline" name="ship_tax_toggle" id="ship_tax_toggle"  @if(@$defaults[4][0]->ship_tax['id']>0) checked @endif>{{trans('general.tax')}} {{config('currency.symbol')}}
