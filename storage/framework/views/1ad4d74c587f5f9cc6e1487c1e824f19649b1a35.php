...
<head>
    ...
    <title><?php if(trim($__env->yieldContent('template_title'))): ?><?php echo $__env->yieldContent('template_title'); ?>
        | <?php endif; ?> <?php echo e(trans('installer_messages.title')); ?></title>
...
<div class="master">
    <div class="box">
        ...
        <ul class="step">
            ...
            <li class="step__item <?php echo e(isActive('LaravelInstaller::environment')); ?> <?php echo e(isActive('LaravelInstaller::environmentWizard')); ?> <?php echo e(isActive('LaravelInstaller::environmentClassic')); ?>">
                <?php if(Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') ): ?>
                    <a href="<?php echo e(route('LaravelInstaller::environmentWizard')); ?>">
        ...
        <div class="text-center alert alert-info">
            Thank you for purchasing our application, for support, submit a ticket here <a
                    href="http://helpdesk.ultimatekode.com">helpdesk.ultimatekode.com</a> Please read the
            help/troubleshoot_guide or public tickets on the helpdesk before
...
<?php /**PATH D:\local_server\htdocs\rose_billing_3\5.files_to_upload\resources\views/vendor/installer/layouts/master.blade.php ENDPATH**/ ?>